			...
			duration-500 ease-in-out overflow-y-auto">
				<div class="mx-10 my-2">
					...
					<div class="justify-items-center md:content-center md:items-center md:place-items-center mt-2">
						<input class="form-input w-40 sm:w-64 sm:h-10 rounded-md pl-4 pr-4 bg-gray-100 focus:border-indigo-600" type="text"
						placeholder="Cari Invoice">
						<select class="w-32 sm:w-64 sm:h-10 rounded-md pl-4 pr-4 focus:border-indigo-600" type="select"
						placeholder="Semua Produk">
							<option>Semua</option>
							<option>Komplain Terbaru</option>
							<option>Komplain Terlama</option>
						</select>
						...
						placeholder="Asal Pengiriman">
							...
							<option>Cabang Pekalongan</option>
							<option>Cabang Jakpus</option>
						</select>
					</div>	
					...
					<div class="mt-4 flex justify-between text-gray-600 dark:text-gray-400">
						<div class="pl-2 flex capitalize">
							...
							<span class="ml-8 flex items-center font-bold">
								Filter Status:
							</span>
								...
								<div class="flex flex-col ml-6">
									...
									<div class="mt-4 flex">
										...
										<button
											...
											<span class="font-semibold ml-1 text-white">Komplain</span>
										</button>
					...
					<div class="flex flex-row mt-6 mb-4">
						<div class="flex w-full items-center justify-between bg-white
							dark:bg-gray-800 px-8 py-20 sm:shadow-lg">
							<!-- card -->
							<div class="flex">
								<img
									class="h-20 w-20 rounded-full object-cover"
