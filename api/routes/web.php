...
$router->group(['prefix' => 'external'], function () use ($router) {
    ...
    $router->get('testVariant',  ['uses' => 'ExternalController@testTransaction']);
    $router->get('testTransaction',  ['uses' => 'ExternalController@testProduct']);
    $router->get('testTransactionProduct',  ['uses' => 'ExternalController@testTransactionProduct']);
    $router->get('testTransactionPayment',  ['uses' => 'ExternalController@testTransactionPayment']);
