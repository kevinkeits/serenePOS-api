...
class ScanOrderController extends Controller
{
    ...
    public function get(Request $request)
    {
        ...
        if ($request->ID) {
            $query = "SELECT MsProduct.ID id, MsProduct.Name name, MsProduct.Qty qty, MsProduct.Price price, MsProduct.Notes notes
                        FROM MsProduct
                        JOIN MsCategory
            ...
            $query = "SELECT MsProduct.ID id, MsProduct.Name name, MsCategory.ID idCategory, MsCategory.Name categoryName, MsProduct.Notes notes, MsProduct.Price price, MsProduct.ImgUrl imgUrl
                        FROM MsProduct
                        JOIN MsCategory
